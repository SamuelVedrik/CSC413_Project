...
MCCRNN_MODEL_OPTS = dict(
    column1_opts=[
        dict(in_channels=1, out_channels=24, kernel_size=(3, 13), padding=(1, 6), stride=1),
        dict(in_channels=24, out_channels=48, kernel_size=(3, 9), padding=(1, 4), stride=1),
        dict(in_channels=48, out_channels=64, kernel_size=(3, 7), padding=(1, 3), stride=1, maxpool_kernel=(4, 2)),
        ],
    column2_opts=[
        dict(in_channels=1, out_channels=24, kernel_size=(13, 3), padding=(6, 1), stride=1),
        dict(in_channels=24, out_channels=48, kernel_size=(9, 3), padding=(4, 1), stride=1),
